...
/**
 * Écran "Notifications" — hors du groupe (shell), même habillage que
 * mission/layout.tsx et modifier-profil/layout.tsx (pas de bottom nav sur un
 * écran de détail plein écran).
 */
